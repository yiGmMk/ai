---
title: "Gemini2.5 Pro生成的SVG代码封神了，提示词一键直出PPT"
date: "2025-09-03"
tags: ["Gemini2.5 Pro", "SVG代码生成", "PPT制作", "提示词技术", "Office文档"]
categories: ["AI"]
description: "通过Gemini2.5 Pro的SVG代码生成能力，结合提示词技术，实现从Word文档一键生成专业PPT的完整解决方案。"
author: "gemini"
image: "https://ai.programnotes.cn/img/ppt/5.png"
---

- **双阶段协作流程**：深度分析文档内容生成设计规范，再按确认的布局规则逐页生成SVG代码
- **自适应结构化卡片系统**：通过网格布局、动态尺寸计算和视觉层级设计实现信息模块化呈现
- **AI驱动的PPT生成方案**：利用SVG代码直接在Office软件中编辑，实现零工具的演示文稿自动化制作

通过提示词+你写好的Word文档，直接生成一份完整的PPT

最近，谷歌发布了Gemini2.5-Pro的预览系列，包括前不久的0605版本，它做了一个很不起眼的加强。加强了SVG代码的生成能力。让提示词+Word文档生成PPT这件事真的变成了可能。

![效果图](https://ai.programnotes.cn/img/ppt/1.png)
...
![效果图](https://ai.programnotes.cn/img/ppt/2.png)
![效果图](https://ai.programnotes.cn/img/ppt/3.png)
![效果图](https://ai.programnotes.cn/img/ppt/4.png)
![效果图](https://ai.programnotes.cn/img/ppt/5.png)

## 步骤

1. 使用提示词生成svg代码
2. 保存为svg文件,可以使用这个网站 [https://www.svgviewer.dev/](https://www.svgviewer.dev/)
3. svg文件拖入Office软件制作ppt

## 来源

- https://linux.do/t/topic/718602